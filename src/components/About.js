				...
				<Fade right cascade>
					<div className='subtitle subtitle--about'>
						<div>
							...
							<p>
								I build responsive websites and mobile apps with optimal
								user experience that achieves your business goals.
							</p>
						</div>
						<div>
							...
							<p>
								...
								customers’ trust and helps you do your business well. I
								make sure your website is up to that standard.
							</p>
						</div>
						<div>
							...
							<p>
								...
								responsive, powerful and fully custom websites. Plus,
								Webflow has an incredibly simple Content Editor for you
								and your team to edit website content quickly and
								easily.
							</p>
						</div>
					</div>
